...
import Radio from "../../Radio"; // plasmic-import: RMg6Z5jRYEGL/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: PiREjNFYgnNN/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__u5Il1)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__sePtv)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__uhdvz)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__mLfCx)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
