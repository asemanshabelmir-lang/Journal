...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: -WeY3vx5jXoJ/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: HBpbda57ohZH/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: Lq6DUSSIPuh7/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__ee59Z)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__pP8U)}
            role={"img"}
          />
        ) : null}
      </div>
