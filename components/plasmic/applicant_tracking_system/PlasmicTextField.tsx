...
import Label from "../../Label"; // plasmic-import: 29HOC4_8DjHx/component
import TextInput from "../../TextInput"; // plasmic-import: BQ21QFaZWkvt/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: 4iTUyIk_oA8G/component
import Description from "../../Description"; // plasmic-import: AoP5pN5_prGg/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: 6CrZYxjx_qde/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__qWaKx, {
          [sty.freeBoxiconEnd__qWaKx7UzCu]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__qWaKxUL0Z]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__qWaKx9Tjd7]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__riR8, {
            [sty.freeBoxiconStart__riR8UL0Z]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__riR89Tjd7]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__oQmA)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__be5Ld, {
            [sty.freeBoxiconEnd__be5Ld7UzCu]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__be5LduL0Z]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__mdQh)}
                role={"img"}
              />
            ),
