...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: lZHgzrRxhMlo/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__rblyo)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__rbW6R)}>
            <div
              className={classNames(
                projectcss.all,
