...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: R8ccW3HwabrW/css

import LoadingIcon from "./icons/PlasmicIcon__Loading"; // plasmic-import: Skq9njImqwom/icon
import Icon9Icon from "./icons/PlasmicIcon__Icon9"; // plasmic-import: U2sSimBUiaco/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon9Icon
          className={classNames(projectcss.all, sty.svg__vJ051)}
          role={"img"}
        />
      }
      menu={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__ogWwt)}>
                <LoadingIcon
                  className={classNames(projectcss.all, sty.svg___05Wjo)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__pB81R)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section___90Ybe)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
