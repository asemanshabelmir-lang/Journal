...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: RMg6Z5jRYEGL/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__wEyvD)}>
        <div className={classNames(projectcss.all, sty.freeBox__cskKl)} />
      </div>
      {renderPlasmicSlot({
