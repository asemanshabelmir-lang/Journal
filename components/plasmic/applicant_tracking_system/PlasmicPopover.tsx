...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: f-Cp_fpvxUbb/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: Z55hI-e6wxSv/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__pGd9R)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button className={classNames("__wab_instance", sty.button__v3LYk)} />
        ),
