...
import SliderThumb from "../../SliderThumb"; // plasmic-import: J8DGuCePvrv7/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: ydrRhnqST7sM/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__k3GdM)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox___5JFzg)}>
        <div
