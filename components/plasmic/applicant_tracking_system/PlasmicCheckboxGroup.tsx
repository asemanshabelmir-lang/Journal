...
import Checkbox from "../../Checkbox"; // plasmic-import: -WeY3vx5jXoJ/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: nmFFGJaxR7B8/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__ghbFc)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___1X3Fl)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__iub13)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___27EBc)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
