...
import sty from "./PlasmicModal.module.css"; // plasmic-import: qsjD8tpGfM86/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_Se_245UoODQb"]]: true })}
          ...
          >
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div
                    className={classNames(projectcss.all, sty.freeBox__ufgeY)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__yZvD)}>
                  <Button
                    color={"muted"}
                    onClick={async event => {
                      const $steps = {};
